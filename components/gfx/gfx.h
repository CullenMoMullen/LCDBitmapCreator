...
//! \brief Standard defintion for the color purple.
#define COLOR_PURPLE        RGB(255,0,255)
//! \brief Standard defintion for the color blue.
#define COLOR_BLUE          RGB(0,0,255)
//! \brief Standard defintion for the color light gray.
#define COLOR_LIGHT_GRAY    RGB(192,192,192)
//! \brief Standard defintion for the color dark gray.
#define COLOR_DARK_GRAY     RGB(128,128,128)
//! \brief Standard defintion for the color dark teal.
#define COLOR_DARK_TEAL     RGB(0,128,128)
//! \brief Standard defintion for the color dark purple.
#define COLOR_DARK_PURPLE   RGB(128,0,128)
//! \brief Standard defintion for the color dark blue.
#define COLOR_DARK_BLUE     RGB(0,0,128)
//! \brief Standard defintion for the color yellow.
#define COLOR_YELLOW        RGB(255,255,0)
//! \brief Standard defintion for the color green.
#define COLOR_GREEN         RGB(0,255,0)
//! \brief Standard defintion for the color dark yellow.
#define COLOR_DARK_YELLOW   RGB(128,128,0)
//! \brief Standard defintion for the color dark green.
#define COLOR_DARK_GREEN    RGB(0,128,0)
//! \brief Standard defintion for the color red.
#define COLOR_RED           RGB(255,0,0)
//! \brief Standard defintion for the color dark red.
#define COLOR_DARK_RED      RGB(128,0,0)
//! \brief Standard defintion for the color black.
...
//! \brief Structure used to define a font.
typedef struct _gfx_Font
{
	//! \brief Private data structure for this font.
	void* pData;
	...
	uint8_t(*GetGlyphWidth)(struct _gfx_Font*, uint16_t);
...
typedef struct _gfx_DeviceContext
{
	...
	//! \brief Points to the currently active gfx_Font_t.
	gfx_Font_t* pFont;
	...
	gfx_Rect_t     m_CurrentSliceRect;  //!< Rectanlge representing the current Slice being drawn
} gfx_DeviceContext_t;
...
extern "C" {
	...
	////////////////////////////////////////////////////////////////////////////////
	//! \brief Selects a gfx_Font_t into a given gfx_DeviceContext_t
	//! \return The previously selected font.
	//! \param[in] pDC          The gfx_DeviceContext_t to operate on to check within.
	//! \param[in] pFont        The gfx_Font_t to select
	////////////////////////////////////////////////////////////////////////////////
	gfx_Font_t* gfx_font_SelectFont(gfx_DeviceContext_t* pDC, gfx_Font_t* pFont);

	////////////////////////////////////////////////////////////////////////////////
	//! \brief Gets the gfx_Font_t that is considered the "system font"
	//! \return The System font.
	////////////////////////////////////////////////////////////////////////////////
	gfx_Font_t* gfx_font_GetSystemFont(void);

	////////////////////////////////////////////////////////////////////////////////
	//! \brief Selects a gfx_Font_t to be the "system font"
	//! \return The previous system font.
	//! \param[in] pFont        The gfx_Font_t to select
	////////////////////////////////////////////////////////////////////////////////
	gfx_Font_t* gfx_font_SetSystemFont(gfx_Font_t* pFont);
	...
	//!
	//! \param[in] pDC  gfx_DeviceContext_t to draw onto
	//! \param[in] destRect *destRect  pointer to destingation rectangle (relative to current origin)
	...
	//!  This is the mechanism through which most bitmaps should be drawn.
	//!
	//! \param[in] pDC           The gfx_DeviceContext_t to draw within
	//! \param[in] *destRect  pointer to destingation rectangle (relative to current origin)
	//! \param[in] uResourceID   Resource ID to draw.
	//! \param[in] *srcRect   pointer to source rectangle to stretch from
	//! \param[in] filterType Re-sampling filter to use for transformation (\ref gfx_StretchFilter_t)
	////////////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////////////
	//! \brief This  is the primary way a user of the graphics library can alpha blend a bitmap into a device context.
	//!
	//! This function draws a bitmap onto the device context, bounded by the clipping region.
	//!
	//! \param[in] pDC        gfx_DeviceContext_t to draw onto
	...
	//! \param[in] pDC           The gfx_DeviceContext_t to draw within
	//! \param[in] ResourceID    Resource ID to draw.
	//! \param[in] x0            the X position to draw (relative to the current origin).
	//! \param[in] y0            the Y position to draw (relative to the current origin).
	//! \param[in] alphaValue    Opacity value for the source bitmap
	//!
	//! \todo This function will also manage the bitmap cache
	////////////////////////////////////////////////////////////////////////////////
	void gfx_bmp_AlphaBlendBitmap(gfx_DeviceContext_t* pDC, uint32_t ResourceID, int x0, int y0, uint8_t alphaValue);
	...
	////////////////////////////////////////////////////////////////////////////////
	//! \brief Draws a string onto the current context, clipped by the active clipping region.
	//!
	//!
	//! \param[in] pDC          The target gfx_DeviceContext_t
	//! \param[in] x            The X coordinate of the upper left of the text box
	//! \param[in] y            The Y coordinate of the upper left of the text box
	//! \param[in] eStringType  String encoding format
	//! \param[in] pString      The string to draw
	//! \param[in] length       The number of characters to draw.
	//! \todo optimize the drawing so that it only draws when within the clipping rect of the widget
	//!
	//! \retval int16_t         Returns the width of the string drawn to the device
	////////////////////////////////////////////////////////////////////////////////
	int16_t gfx_text_DrawString(gfx_DeviceContext_t* pDC, int x, int y, txt_StringTypesEnum_t eStringType, void* pString, uint32_t length);

	////////////////////////////////////////////////////////////////////////////////
	//! \brief Draws a string onto the current context with orientation, clipped by the active clipping region.
	//!
	//!
	//! \param[in] pDC          The target gfx_DeviceContext_t
	//! \param[in] x            The X coordinate of the upper left of the text box
	...
	//! \param[in] pString      The string to draw
	//! \param[in] length       The number of characters to draw.
	//! \param[in] eOrientation The orientation of the string.
	//! \todo optimize the drawing so that it only draws when within the clipping rect of the widget
	//!
	//! \retval int16_t         Returns the width of the string drawn to the device
	////////////////////////////////////////////////////////////////////////////////
	int16_t gfx_text_DrawStringEx(gfx_DeviceContext_t* pDC, int x, int y, txt_StringTypesEnum_t eStringType, void* pString,
		uint32_t length, gfx_OrientationEnum_t eOrientation);
	...
	//!
	//! \param[in] pBitmapCache Pointer to LRU cache for bitmaps
	...
	////////////////////////////////////////////////////////////////////////////////
	RtStatus_t gfx_Initialize(util_lru_Cache_t* pBitmapCache, uint16_t u16RectNodes, uint16_t u16ClipNodes);
